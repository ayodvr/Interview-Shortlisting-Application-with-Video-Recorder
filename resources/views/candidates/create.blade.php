            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('candidates.upload')}}" class="btn btn-danger w-xs waves-effect waves-light" style="float: right">Upload Candidates</a>
                                <h4 class="card-title mb-4">Create candidate</h4>
                                <br>
