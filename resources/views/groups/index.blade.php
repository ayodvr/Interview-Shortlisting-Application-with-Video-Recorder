                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('groups.upload')}}" class="btn btn-info w-xs waves-effect waves-light" style="float: right">Upload group</a>
                            &NonBreakingSpace;&NonBreakingSpace;&NonBreakingSpace;
                            <a href="{{route('groups.create')}}" class="btn btn-primary w-xs waves-effect waves-light float-left" style="float: right">Add group</a>
                            <br><br><br>
